...
def main():
    log_dir = Path("../../../emergent-factorization-engine/tests/logs")
    output_csv = Path("../../../emergent-factorization-engine/tests/summary.csv")
    ...
    with open(output_csv, "w", newline="") as csvfile:
        ...
        for log_file in log_dir.glob("ablation_*.json"):
